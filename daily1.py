...
list1 = [1,2,3,4,5,'a','Kshitij',"Parashar",True]  #list type of object with data
list1  #print when through spyder
Africatype(list1)  #type of object
print(list1)  #print when running complete file
list1
sorted([1,5,3,2,4,5,324,43,4,4,3,23,434,53442,244,2245224,523]) #Creating a list and sorting it as well
list2 = ['f','c','d','e','f']
list2
list2.count('f')
len(list2)
...
#%%   #just to draw a horizontal line
...
for i in list1:    print('Kshitij ', i + 3)
